        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <nav class="nav">
                    ...
                    <a href="vistaMedico.php">Agenda</a>
    ...
    <section class="footer" id="footer">
        <div class="box-container">
            <div class="box">
                ...
                <a href="vistaMedico.php"><i class="fas fa-chevron-right"></i>Agenda</a>
                <a href="perfilMdico.php"><i class="fas fa-chevron-right"></i> Perfil </a>
            </div>
